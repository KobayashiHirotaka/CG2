...
void DirectXCommon::Initialization(WindowsApp* win, const wchar_t* title, int32_t backBufferWidth, int32_t backBufferHeight) {

	win_ = win;
	backBufferWidth_ = backBufferWidth;
	backBufferHeight_ = backBufferHeight;

	win_->CreateWindowView(title, 1280, 720);
...
void DirectXCommon::CreateSwapChain() {
	//スワップチェーン
	swapChain_ = nullptr;
	swapChainDesc_.Width = WindowsApp::kClientWidth;//画面の幅
	swapChainDesc_.Height = WindowsApp::kClientHeight;//画面の高さ
